...
namespace XtendedMenu
{
    ...
    internal static class AttributesInfo
    {
        ...
        internal static void GetFileAttributes(string folderPath)
        {
            ...
            {
                StartProcess.StartInfo(AttributesInfo.GetAssembly.AssemblyInformation("directory") + @"\XtendedMenu.exe", "\"" + wex.Message + Environment.NewLine + wex.StackTrace + Environment.NewLine + wex.Source + Environment.NewLine + wex.GetBaseException() + Environment.NewLine + wex.TargetSite + "\"" + " -catchhandler");
            }
            catch (Exception ex)
            {
                StartProcess.StartInfo(AttributesInfo.GetAssembly.AssemblyInformation("directory") + @"\XtendedMenu.exe", "\"" + ex.Message + Environment.NewLine + ex.StackTrace + Environment.NewLine + ex.Source + Environment.NewLine + ex.GetBaseException() + Environment.NewLine + ex.TargetSite + "\"" + " -catchhandler");
